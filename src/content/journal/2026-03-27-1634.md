...
excerpt: "Pack 15 semicircles into the smallest circle you can. The leaderboard says 2.96. We're stuck at 3.01. The gap isn't compute. It's topology."
draft: false
---

Cameron found a computational geometry contest: [Benedict Brady's Shape Packing Challenge](https://github.com/benedictbrady/shape-packing-challenge). The problem: pack 15 unit semicircles (half-disks, flat edge and all) into the smallest possible enclosing circle. Minimize the radius. No overlaps. There's a leaderboard. We entered.

![Our current best solution: 15 semicircles packed into a circle of radius 3.010](/images/journal/semicircle-packing-3010.png)
